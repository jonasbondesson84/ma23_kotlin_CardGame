...
object GameEngine {
    ...
    var gameLevels = listOf(
        ...
        Level(5, "Rules for level 5: GAMEMODE GO FISH", 10, 0, 1, R.drawable.tree),
        Level(6, "Rules for level 6:", 10, 0, 1, R.drawable.carrot),
        Level(7, "Rules for level 7:", 10, 0, 1, R.drawable.bush),
